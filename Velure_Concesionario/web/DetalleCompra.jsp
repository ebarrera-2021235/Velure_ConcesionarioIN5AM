                    ...
                    <div class="card-body">
                        <form action="Controlador?menu=DetalleCompra" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" value="${detalleCompra.precioUnitario}" name="txtPrecioUnitario" class="form-control" required>
                            </div>
                            <div class="form-group">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="acciones-btns">
                                                <a class="btn-action-minimal btn-edit-minimal" href="Controlador?menu=DetalleCompra&accion=Editar&codigoDetalleCompra=${detalleCompra.codigoDetalleCompra}">Editar</a>    
                                                <a class="btn-action-minimal btn-delete-minimal" href="Controlador?menu=DetalleCompra&accion=Eliminar&codigoDetalleCompra=${detalleCompra.codigoDetalleCompra}" onclick="confirmarEliminar(event, this);">Eliminar</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
